...
}{Expansion of lagrangian definitions.}
...
$2\multsp \ScriptCapitalB _{0}\multsp
 \langle \bigg(
     \frac{\DoubleStruckCapitalI \DoubleStruckD \multsp {{(m_{\pi })}^2}}
      ...
      \DoubleStruckCapitalI \DoubleStruckD \multsp {{{{s}}}^0}\bigg)\SixPointedStar \Bigg(
    \\
 -\frac{\ImaginaryI \multsp \overvar{{{\pi }}}{\rightarrow }\cdot 
   ...
   \frac{\overvar{{{\pi }}}{\rightarrow }\cdot \overvar{\sigma }{\rightarrow }
      \SixPointedStar \overvar{{{\pi }}}{\rightarrow }\cdot 
       \overvar{\sigma }{\rightarrow }}{2\multsp {{(f_{\pi })}^2}}+ 
\frac{\ImaginaryI \multsp 
      \bigg(\overvar{{{\pi }}}{\rightarrow }\cdot \overvar{\sigma }{\rightarrow }
         \SixPointedStar \overvar{{{\pi }}}{\rightarrow }\cdot 
          \overvar{\sigma }{\rightarrow }\SixPointedStar 
        \overvar{{{\pi }}}{\rightarrow }\cdot \overvar{\sigma }{\rightarrow }\bigg)}
      {6\multsp {{(f_{\pi })}^3}}+  \\
   \frac{\overvar{{{\pi }}}{\rightarrow }\cdot 
           \overvar{\sigma }{\rightarrow }\SixPointedStar 
          \overvar{{{\pi }}}{\rightarrow }\cdot \overvar{\sigma }{\rightarrow }
          \SixPointedStar \overvar{{{\pi }}}{\rightarrow }\cdot 
          \overvar{\sigma }{\rightarrow }\SixPointedStar 
        \overvar{{{\pi }}}{\rightarrow }\cdot \overvar{\sigma }{\rightarrow }}{24
        \multsp {{(f_{\pi })}^4}}+\DoubleStruckCapitalI \DoubleStruckD \Bigg)
    \rangle$}{If space-time arguments are supplied, the matrices are automatically expanded.}
\domtog{
