...
%are particularly useful if CPU time is an issue and/or if truly large expressions occur.
%and a very efficient way to handle those  expressions is needed.
%FORM is very much suited for this task. 
%On the other hand,
general purpose computer algebra system, has a more intuitive
%flexibility in their
user interface and built-in mathematical knowledge.
%one can use the already provided libraries for operations like
